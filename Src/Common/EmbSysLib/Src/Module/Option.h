...
class Option
{
  public:
    ...
    //---------------------------------------------------------------
    Option(int argc, const char **argv, const char *nameIn, const char *defaultIn = NULL)
    {
    ...
    void scan(int argc, const char **argv, const char *nameIn, const char *defaultIn )
    {
      if(defaultIn)
...
#if wxUSE_GUI
    void scan(int argc, wxChar **argv, const char *nameIn, const char *defaultIn)
    {
